...
//   const { data: datewiseData, loading, error } = useSelector((state) => state.datewise);
...
//   const displayDate = reduxData?.date
//     ? new Date(reduxData.date) 
//     : new Date();
...
//       {showModal && (
//         <div className="fixed inset-0  bg-opacity-50 bg-opacity-30 backdrop-blur-sm  flex items-center justify-center z-50 p-4">
        ...
        <div className="fixed inset-0 bg-opacity-50 bg-opacity-30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-auto">
            <div className="flex justify-between items-center p-6 border-b border-gray-200">
              ...
              <button
                onClick={handleCloseModal} // Use the new handler here
                className="text-gray-500 hover:text-gray-700 cursor-pointer transition-colors"
              >
                <IoIosClose size={24} />
              </button>
            ...
            <div className="flex justify-end p-6 border-t border-gray-200">
              <button
                onClick={handleCloseModal} // Use the new handler here too
                className="cursor-pointer px-4 py-2 bg-[#308BF9] text-white rounded-md hover:bg-blue-600 transition-colors"
              >
                Close
              </button>
